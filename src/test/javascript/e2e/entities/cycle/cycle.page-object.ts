...
export class CycleDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('pandaFitMonolithApp.cycle.delete.question'));
...
export default class CycleComponentsPage {
  ...
  async deleteCycle() {
    ...
    expect(await cycleDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/pandaFitMonolithApp.cycle.delete.question/);
