...
@RestController
@RequestMapping("/api/panda-fit-monolith-kafka")
public class PandaFitMonolithKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PandaFitMonolithKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PandaFitMonolithKafkaResource(KafkaProperties kafkaProperties) {
